...
from clipscribe.models import (
    ...
    VideoMetadata, EnhancedEntity, EntityContext, TemporalMention
)
...
class TestRelationshipEvidenceExtractor:
    ...
    def test_detect_contradictions(self):
        ...
        contradiction_transcript = VideoTranscript(
            ...
            segments=[
                {
                    "text": "Biden announced sanctions against Russia.",
                    "timestamp": "00:01:30"
                },
                {
        ...
        contradictions = self.extractor._detect_contradictions(relationship, contradiction_transcript)
