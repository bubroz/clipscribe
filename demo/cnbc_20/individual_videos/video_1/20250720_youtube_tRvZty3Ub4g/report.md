...
graph TD
    ...
    Chevron -->|"prevailed_in_mediation_with"| Exxon
    Mediation_decision -->|"clears_way_for"| Chevrons_acquisition_of_Hess
    Chevron -->|"will_acquire"| Hess
    Jay_Powell -->|"holds_title_of"| Federal_Reserve_chair
    Jay_Powell -->|"sent_letter_to"| Office_of_Management_and_Budget
    Financial_Times -->|"reported_on"| AI_startup_Perplexity
    Hess_stock -->|"increased_by"| 8_and_a_half%
    Chevron_stock -->|"increased_by"| 3.7%
    Chevron -->|"impacts_stock_of"| acquisition_of_Hess
    Hess -->|"impacts_stock_of"| acquisition_of_Hess
    Mediation -->|"concerned_in_mediation"| Guyana_oil_assets
    Jay_Powell -->|"responded_to_questions_from"| White_House
    renovations -->|"are_for"| Central_Banks_DC_headquarters
    Jay_Powell -->|"provided_details_on"| project_cost_overruns
    Exxon -->|"resolved_dispute_with"| Chevron
    Chevron -->|"target_of_acquisition_by"| Hess
    Federal_Reserve -->|"are_located_at"| DC_headquarters
    Central_Bank -->|"is_also_known_as"| Federal_Reserve
    Perplexity -->|"valuation_rose_to"| $18_billion
    White_House -->|"posed_questions_about"| renovations

    %% Styling
    class Hess personClass
    class Federal_Reserve organizationClass
...
<details>
<summary><b>📦 PRODUCT (1 found)</b></summary>
...
---
*Generated by ClipScribe v2.6.0 on 2025-07-20 at 17:15:30*
