...
- **Gemini 2.5 Pro**: Reserved for complex, high-reasoning tasks such as multi-video collection synthesis, advanced temporal analysis, and knowledge graph cleaning.

All prompts optimized for completeness without arbitrary limits

We exclusively use the 2.5 generation models to ensure we are always leveraging the latest technology. We do not use older models like 1.5. 