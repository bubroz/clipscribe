...
class GrokProvider(IntelligenceProvider):
    ...
    async def extract(
        ...
        try:
            ...
            from clipscribe.prompts.intelligence_extraction import (
                create_intelligence_extraction_prompt,
            )
            ...
            hit_rate_percent = (
                (cached_tokens / total_input_tokens * 100) if total_input_tokens > 0 else 0.0
            )
