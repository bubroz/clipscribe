...
class DualModeTranscriber:
    ...
    def __init__(self, default_mode: str = "auto", force_local_whisperx: bool = False):
        """
    ...
    def detect_content_type(
        self, video_metadata: Optional[Dict[str, Any]] = None, user_preference: Optional[str] = None
    ) -> str:
        """
    ...
    async def transcribe_with_both(self, audio_path: str) -> Dict[str, Dict[str, Any]]:
        """
        ...
        return {"voxtral": voxtral_result, "whisperx": whisperx_result, "comparison": comparison}
