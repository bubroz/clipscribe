...
class BatchExtractor:
    ...
    def _build_mega_prompt(self, media_type: str) -> str:
        ...
        media_instructions = """Analyze this video and provide:
1. A complete transcript of all spoken words
2. Descriptions of important visual elements (slides, code, diagrams)
3. Note any on-screen text or annotations""" if media_type == "video" else "Transcribe this audio completely and accurately."
