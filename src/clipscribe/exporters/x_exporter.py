...
"""
    ...
    def _generate_fallback_summary(
        self, title: str, entities: list, relationships: list, max_length: int
    ) -> str:
    ...
    def save_x_draft(
        self, summary: str, video_url: str, thumbnail_path: Optional[str], output_dir: Path
    ) -> dict:
        """
...
async def test_x_generator():
    ...
    summary = await generator.generate_sticky_summary(
        "Partnering with Barbell Apparel", entities, relationships
    )
    ...
    draft_files = generator.save_x_draft(
        summary, "https://youtube.com/watch?v=test", None, Path("output/test_x_draft")
    )
