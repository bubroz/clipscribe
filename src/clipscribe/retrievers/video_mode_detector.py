...
class VideoModeDetector:
    ...
    async def _detect_text_in_frames(self, video_path: str) -> Tuple[bool, float]:
        ...
        text_patterns = [
            "tutorial", "course", "lecture", "presentation",
            "slides", "code", "programming", "demo"
        ]
        ...
        audio_patterns = [
            "podcast", "interview", "discussion", "briefing",
            "news", "talk"
        ]
    ...
    def _make_recommendation(self, analysis: VideoAnalysis, metadata: Dict) -> VideoAnalysis:
        ...
        if video_score >= 50:
            ...
            analysis.reasoning = "Audio sufficient: " + (", ".join(reasons) if reasons else "Standard video content")
