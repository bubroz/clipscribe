...
This replaces the old Gemini-based VideoIntelligenceRetriever.
"""
...
class VideoIntelligenceRetrieverV2:
    ...
    async def process_url(self, video_url: str) -> Optional[VideoIntelligence]:
        ...
        try:
            ...
            saved_files = await self._save_outputs(result)
    ...
    async def _save_outputs(self, result: VideoIntelligence) -> Dict[str, Any]:
        """
        ...
        output_subdir = self.output_dir / f"{timestamp}_{result.metadata.platform}_{video_id}"
