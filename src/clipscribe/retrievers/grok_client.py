...
class GrokAPIClient:
    ...
    async def chat_completion(
        ...
        **kwargs,
        ...
        Args:
            ...
            model: Model to use (grok-4-1-fast-reasoning, grok-4-1-fast-non-reasoning)
    ...
    def calculate_cost(
        ...
        Args:
            ...
            model: Model used (grok-4-1-fast-reasoning or grok-4-1-fast-non-reasoning)
        ...
        pricing_standard = {
            ...
            "grok-4-1-fast-reasoning-latest": {"input": 0.20, "output": 0.50, "cached": 0.05},
        }

        # High-context tier (>128K context) - rare, only 12+ hour videos
        pricing_high_context = {
            "grok-4-1-fast-reasoning": {"input": 0.40, "output": 1.00, "cached": 0.05},
            "grok-4-1-fast-non-reasoning": {"input": 0.40, "output": 1.00, "cached": 0.05},
        }
        ...
        rates = pricing.get(model, pricing_standard["grok-4-1-fast-reasoning"])
    ...
    async def create_collection(
        self, name: str, description: str = "", model: str = "grok-4-1-fast-reasoning"
    ) -> Dict[str, Any]:
        """
