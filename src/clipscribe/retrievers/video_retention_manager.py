...
class VideoRetentionManager:
    ...
    def _analyze_retention_costs(
        ...
        reprocessing_cost = self.settings.estimate_cost(
            duration_seconds, 
            self.settings.temporal_intelligence_level
        )
    ...
    def _make_retention_decision(
        ...
        if policy == VideoRetentionPolicy.DELETE:
            ...
            return {
                "action": "archive",
                "reason": "Policy: Keep all source videos"
            }
            ...
            return {
                "action": "delete",
                "reason": "Unknown policy, defaulting to delete"
            }
    ...
    def _update_retention_history(
        ...
        if action == "archived":
            ...
            self.retention_history["retention_stats"]["total_storage_cost"] += cost_analysis.storage_cost_yearly
            ...
            self.retention_history["retention_stats"]["total_saved_cost"] += cost_analysis.storage_cost_yearly
    ...
    def cleanup_archive(self, max_age_days: int = 365) -> Dict[str, Any]:
        ...
        for video_file in self.archive_dir.rglob("*"):
            if video_file.is_file() and video_file.suffix in ['.mp4', '.mkv', '.avi', '.mov', '.wmv']:
                # Check file age
    ...
    def get_retention_stats(self) -> Dict[str, Any]:
        ...
        stats.update({
            ...
            "archive_utilization": (archive_size / (1024**3)) / self.retention_config['max_archive_size_gb'],
    ...
    def recommend_policy_optimization(self) -> Dict[str, Any]:
        ...
        if total_videos > 0:
            ...
            elif retention_rate < 0.2 and self.retention_config['policy'] != VideoRetentionPolicy.DELETE:
                recommendations.append({
                    "type": "policy_change",
