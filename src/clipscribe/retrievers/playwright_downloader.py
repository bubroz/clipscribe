...
class PlaywrightDownloader:
    ...
    async def download_video_page(
        ...
        try:
            ...
            if "youtube.com" in url or "youtu.be" in url:
                ...
                metadata = {"url": url, "title": title, "method": "playwright_validation"}
    ...
    async def download_with_playwright_cookies(
        self, url: str, output_dir: Optional[str] = None
    ) -> Tuple[str, dict]:
        """
...
async def download_with_playwright_fallback(
