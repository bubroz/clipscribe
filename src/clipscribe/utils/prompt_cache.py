...
class GrokPromptCache:
    ...
    def estimate_cache_savings(
        self, input_tokens: int, cache_hit: bool, model: str = "grok-4-1-fast-reasoning"
    ) -> float:
        """
        ...
        Args:
            ...
            model: Model being used (grok-4-1-fast-reasoning or grok-4-1-fast-non-reasoning)
        ...
        pricing = {
            ...
            "grok-4-1-fast": 0.20,  # Alias
            "grok-4-1-fast-reasoning-latest": 0.20,  # Alias
        }

        rate = pricing.get(model, pricing["grok-4-1-fast-reasoning"])
