...
class SpeakerIdentifier:
        ...
        if manual_overrides:
            ...
            for segment in speaker_segments:
                ...
                if label in manual_overrides:
                    overridden.append(SpeakerIdentity(
                        speaker_label=label,
            ...
            remaining_speakers = [
                ...
                if s.get('speaker') not in manual_overrides
            ]
        else:
            overridden = []
    ...
    def _build_identification_context(
        ...
        for spk in speakers:
            ...
            context_parts.append(
                f"{label}: {time:.1f}s speaking time, {segs} segments"
            )
        context_parts.append("")
...
"""
            ...
            async with httpx.AsyncClient(timeout=60) as client:
                ...
                for ident in identifications:
                    ...
                    if conf >= self.confidence_threshold:
                        results.append(SpeakerIdentity(
                ...
                logger.info(f"Identified {sum(1 for r in results if r.identified_name)} of {len(results)} speakers")
                return results
    ...
    def _fallback_unknown_speakers(
        self, 
        speakers: List[Dict[str, Any]]
    ) -> List[SpeakerIdentity]:
    ...
    def format_transcript_with_names(
        ...
        identifications: List[SpeakerIdentity]
    ) -> str:
        """
